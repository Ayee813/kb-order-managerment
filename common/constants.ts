...
export const GOOGLE_SHEET_ID = "1dpnUaWjVfCXcLVf9ikVJ3eF3JVb4MhrVbN25O8eAQfs";
export const GOOGLE_DRIVE_FOLDER_ID = "1NJX9DymYrWhziVM9htV1NkLHgH0trNm4";
export const GOOGLE_OAUTH_CLIENT_ID = "102983849258809754086";
export const GOOGLE_SERVICE_ACCOUNT_EMAIL =
  "kb-store@kbstore-470205.iam.gserviceaccount.com";
